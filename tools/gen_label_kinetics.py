...
dataset_path = '/home/nirahurk/temporal-shift-module/out_dir/'
label_path = '/home/nirahurk/temporal-shift-module/kinetics/'

if __name__ == '__main__':
    with open('kinetics_label_map_new.txt') as f:
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for line in lines:
            ...
            if this_catergory=='arranging_flowers':
