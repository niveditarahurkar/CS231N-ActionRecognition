...
ROOT_DATASET = '/home/nirahurk/temporal-shift-module/'  # '/data/jilin/'


def return_ucf101(modality):
    #filename_categories = 'UCF101/labels/classInd.txt'
    filename_categories = 'ucfdata/data/ucf101_splits/classInd.txt'
    if modality == 'RGB':
        #root_data = ROOT_DATASET + 'UCF101/jpg'
        root_data = ROOT_DATASET + 'train/train/'
        #filename_imglist_train = 'UCF101/file_list/ucf101_rgb_train_split_1.txt'
        filename_imglist_train = 'ucfdata/data/ucf101_rgb_train_split_1.txt'
        #filename_imglist_val = 'UCF101/file_list/ucf101_rgb_val_split_1.txt'
        filename_imglist_val = 'ucfdata/data/ucf101_rgb_val_split_1.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'UCF101/jpg'
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'out_dir'
        filename_imglist_train = 'kinetics/labels/train_videofolder.txt'
        filename_imglist_val = 'kinetics/labels/train_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
